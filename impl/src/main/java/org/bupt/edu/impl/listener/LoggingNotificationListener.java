...
/**
 * This is default implementation of a notification org.bupt.edu.impl.listener listening to notifications defined
 ...
 * <p>
 * The Example-notifications model contains just a single notification definition and thus this org.bupt.edu.impl.listener
 * implements only a single method. Each model with 1 or more notifications gets just a single org.bupt.edu.impl.listener where
