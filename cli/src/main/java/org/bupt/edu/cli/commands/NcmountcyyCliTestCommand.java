 ...
 */
package org.bupt.edu.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.bupt.edu.cli.api.NcmountcyyCliCommands;
...
public class NcmountcyyCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(NcmountcyyCliTestCommand.class);
    protected final NcmountcyyCliCommands service;

    public NcmountcyyCliTestCommand(final NcmountcyyCliCommands service) {
